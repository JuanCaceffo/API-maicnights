...
class CommentBoostrap(
    ...
    val ticket1 = Ticket(showBoostrap.shows["LaVelaPuerca_GranRex"]!!, showBoostrap.shows["LaVelaPuerca_GranRex"]!!.dates.first() ,StadiumSeatType.UPPERLEVEL, showBoostrap.shows["LaVelaPuerca_GranRex"]!!.ticketPrice(StadiumSeatType.UPPERLEVEL))
    val ticket2 = Ticket(showBoostrap.shows["PearlJam_River"]!!, showBoostrap.shows["PearlJam_River"]!!.dates.first() ,StadiumSeatType.UPPERLEVEL, showBoostrap.shows["PearlJam_River"]!!.ticketPrice(StadiumSeatType.UPPERLEVEL))
    val ticket3 = Ticket(showBoostrap.shows["LaVelaPuerca_TeatroColon"]!!, showBoostrap.shows["LaVelaPuerca_TeatroColon"]!!.dates.first() ,StadiumSeatType.UPPERLEVEL, showBoostrap.shows["LaVelaPuerca_GranRex"]!!.ticketPrice(StadiumSeatType.UPPERLEVEL))
    ...
    fun addComments() {
        sol.addComment(commentMap["GrandRexComment1"]!!,ticket1)
        pablo.addComment(commentMap["GrandRexComment2"]!!,ticket1)
        juan.addComment(commentMap["GrandRexComment3"]!!,ticket1)
        denise.addComment(commentMap["GrandRexComment4"]!!,ticket1)
        sol.addComment(commentMap["RiverComment1"]!!,ticket2)
        pablo.addComment(commentMap["RiverComment2"]!!,ticket2)
        juan.addComment(commentMap["RiverComment3"]!!,ticket2)
        denise.addComment(commentMap["RiverComment4"]!!,ticket2)
        pablo.addComment(commentMap["ColonComments"]!!,ticket3)
